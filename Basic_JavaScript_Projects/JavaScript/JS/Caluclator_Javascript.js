...
function Input_Digit(digit) {
    ...
    //This checks if the WaitSecondOperand is true and sets DisplayValue
    //to the key that was clicked on
    if (Wait_Second_Operand === true) {
        Calculator.Display_Value = digit;
        Calculator.Wait_Second_Operand = false;
    } else {
        //This overwirtes DisplayValue if the current value is 0
...
function Handle_Operator(Next_Operator) {
    ...
    //Checks if the operator already exists and if WaitSecondOperand is true
...
//This funciton updates the calculator screen with the contents of DisplayValue
